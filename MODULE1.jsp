...
<rw:dataArea id="MGDEPARTMENTIDGRPFR32">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBDEPARTMENTID32" asArray="no"/> class="OraColumnHeader"> Departmentid </th>
   <th <rw:id id="HBDEPARTMENTNAME32" asArray="no"/> class="OraColumnHeader"> Departmentname </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGDEPARTMENTID321" src="G_DEPARTMENTID">
   <tr>
    <td <rw:headers id="HFDEPARTMENTID32" src="HBDEPARTMENTID32"/> class="OraCellNumber"><rw:field id="FDEPARTMENTID32" src="DEPARTMENTID" nullValue="&nbsp;"> F_DEPARTMENTID </rw:field></td>
    <td <rw:headers id="HFDEPARTMENTNAME32" src="HBDEPARTMENTNAME32"/> class="OraCellText"><rw:field id="FDEPARTMENTNAME32" src="DEPARTMENTNAME" nullValue="&nbsp;"> F_DEPARTMENTNAME </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
