...
<report name="Department_report" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="DEPARTMENT_REPORT" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL DEPARTMENT.DEPARTMENTID, DEPARTMENT.DEPARTMENTNAME
FROM DEPARTMENT ]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_DEPARTMENTID">
        <displayInfo x="1.15759" y="1.94995" width="1.68494" height="0.61963"
        />
        <dataItem name="DEPARTMENTID" oracleDatatype="number" columnOrder="11"
         width="22" defaultWidth="90000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Departmentid">
          <dataDescriptor expression="DEPARTMENT.DEPARTMENTID"
           descriptiveExpression="DEPARTMENTID" order="1" width="22"
           precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DEPARTMENTNAME" datatype="vchar2" columnOrder="12"
         width="255" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Departmentname">
          <dataDescriptor expression="DEPARTMENT.DEPARTMENTNAME"
           descriptiveExpression="DEPARTMENTNAME" order="2" width="255"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
  ...
  <section name="main">
    <body>
      <frame name="M_G_DEPARTMENTID_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="2.87500" height="0.37500"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_DEPARTMENTID" source="G_DEPARTMENTID"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_DEPARTMENTID" source="DEPARTMENTID" minWidowLines="1"
          ...
          <field name="F_DEPARTMENTNAME" source="DEPARTMENTNAME"
        ...
        <frame name="M_G_DEPARTMENTID_HDR">
          ...
          <text name="B_DEPARTMENTID" minWidowLines="1">
          ...
          <text name="B_DEPARTMENTNAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.37500" y="0.00000" width="1.50000"
             height="0.18750"/>
...
<rw:dataArea id="MGDEPARTMENTIDGRPFR233">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBDEPARTMENTID233" asArray="no"/> class="OraColumnHeader"> Departmentid </th>
   <th <rw:id id="HBDEPARTMENTNAME233" asArray="no"/> class="OraColumnHeader"> Departmentname </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGDEPARTMENTID2331" src="G_DEPARTMENTID">
   <tr>
    <td <rw:headers id="HFDEPARTMENTID233" src="HBDEPARTMENTID233"/> class="OraCellNumber"><rw:field id="FDEPARTMENTID233" src="DEPARTMENTID" nullValue="&nbsp;"> F_DEPARTMENTID </rw:field></td>
    <td <rw:headers id="HFDEPARTMENTNAME233" src="HBDEPARTMENTNAME233"/> class="OraCellText"><rw:field id="FDEPARTMENTNAME233" src="DEPARTMENTNAME" nullValue="&nbsp;"> F_DEPARTMENTNAME </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
</table>
